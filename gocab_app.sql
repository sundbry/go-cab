...
--
-- Table structure for table `gc_service_order`
--

DROP TABLE IF EXISTS `gc_service_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gc_service_order` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `csr_id` int(10) unsigned NOT NULL,
  `css_id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `gc_service_order`
--

LOCK TABLES `gc_service_order` WRITE;
/*!40000 ALTER TABLE `gc_service_order` DISABLE KEYS */;
INSERT INTO `gc_service_order` VALUES (1,3,2,'2012-05-24 05:18:03'),(2,3,2,'2012-05-24 05:18:30'),(3,3,3,'2012-05-24 05:20:01');
/*!40000 ALTER TABLE `gc_service_order` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `gc_service_station` VALUES (2,'234 Taxi','(805) 548-9998','234taxi.com','San Luis Obispo','CA','35.28269170000000','-120.66336869999998',50),(3,'Ali G\'s Limo Service','(805) 544-0601','aligslimoservice.com','San Luis Obispo','CA','35.28611080000000','-120.65465369999998',50),(4,'Surf Cab Company','(805) 574-8220','surfcabco.com','Los Osos','CA','35.31507430000000','-120.82595930000002',50),(5,'Santa Barbara Checker Cab Co','(805) 596-4666','www.santabarbaracheckercab.com','Santa Barbara','CA','34.43565100000000','-119.82980700000002',50),(6,'Organic Taxi','(310) 025-6709','organictaxi.com','Santa Monica','CA','34.00860460000000','-118.47835680000003',50);
...
-- Dump completed on 2012-05-24  5:21:02
